<nav class="navbar navbar-expand-lg bg-body py-0 position-sticky top-0 z-3 px-0 non-e-learning-nav">
    <div class="container border-bottom border-custom border-2">
        <a class="navbar-brand py-0" href="{{ url('/') }}">
            ...
            <img src="{{ asset('img/Logo Organic Marketing small (1).png') }}" alt="Bootstrap" width="" height=""
                class="d-md-none p-2 " style="max-height: 80px;">
            <img src="{{ asset('img/Logo Organic Marketing (3).png') }}" alt="Bootstrap" width="" height=""
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav fw-max-bold" style="font-family: Montserrat, sans-serif;">
                ...
                <div class="d-sm-flex d-lg-none my-3">
                    <a class="btn btn-primary me-2 p-xl-4 p-lg-3 fs-4 fw-bold rounded-4" href="#" role="button">Tư vấn học</a>
                    <a class="btn btn-primary p-xl-4 p-lg-3 fs-4 fw-bold rounded-4" href="#" role="button">Tư vấn CRM</a>
                </div>
            </ul>
        </div>

        <div class="d-flex two-button">
            <a class="btn btn-primary me-2 p-lg-3 p-xl-4 fs-4 rounded-4 fw-bold" href="#" role="button">Tư vấn học</a>
            <a class="btn btn-primary p-lg-3 p-xl-4 fs-4 rounded-4 fw-bold" href="#" role="button">Tư vấn CRM</a>
        </div>
