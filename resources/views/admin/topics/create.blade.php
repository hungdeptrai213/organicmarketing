...
@section('title', 'New Topic - Admin')

@section('content')
<div class="container mt-6 width-60">
    <h1 class="fw-max-bold fs-custom mb-4">New topic</h1>
    ...
    <form action="{{ route('admin.topics.store') }}" method="POST" class="border border-2 border-dark rounded-5 shadow-custom p-4 bg-white">
        @csrf
        <div class="mb-3">
