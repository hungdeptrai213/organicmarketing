...
<div class="container mt-6 width-60">
    <h1 class="fw-max-bold fs-custom mb-4">Industries</h1>
    ...
    <form method="GET" action="{{ route('admin.industries.index') }}" class="mb-3 d-flex gap-2">
        <input type="text" name="q" value="{{ request('q') }}" class="form-control" placeholder="Search industries">
        <button type="submit" class="btn btn-primary">Search</button>
        <a href="{{ route('admin.industries.create') }}" class="btn btn-success ms-auto">New industry</a>
    </form>
    ...
    <div class="table-responsive">
        <table class="table table-bordered align-middle">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="3" class="text-center">No industries.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
